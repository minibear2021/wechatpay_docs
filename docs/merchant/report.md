...
@@ -24,7 +24,7 @@
 ...
 - [刷脸支付](https://pay.weixin.qq.com/doc/v3/merchant/4012647399.md)
 ## JSAPI支付
...
@@ -76,7 +76,7 @@
 - [管理商户号绑定的APPID账号](https://pay.weixin.qq.com/doc/v3/merchant/4013289251.md)
 - [各主体可申请的基础支付权限列表](https://pay.weixin.qq.com/doc/v3/merchant/4015477838.md)
 ## H5支付
...
@@ -129,7 +129,7 @@
 - [各主体可申请的基础支付权限列表](https://pay.weixin.qq.com/doc/v3/merchant/4015616698.md)
...
@@ -421,7 +421,7 @@
 - [汽车租赁](https://pay.weixin.qq.com/doc/v3/merchant/4012587354.md)
 - [酒店行业](https://pay.weixin.qq.com/doc/v3/merchant/4012587370.md)
 ## 微信支付分停车服务
...
@@ -506,7 +506,7 @@
 - [获取支付有礼活动列表](https://pay.weixin.qq.com/doc/v3/merchant/4012489126.md)
 - [删除活动发券商户号](https://pay.weixin.qq.com/doc/v3/merchant/4012466787.md)
 ## 小程序发券插件
...
| 241 | [产品介绍](pages/4012711988.md) | `4012711988` | 2026-05-26 09:26:58 | 商家转账 |
