...
@@ -7,7 +7,7 @@
 ## Skills
 > Skills 为接入微信支付基础支付的开发者提供了一站式的智能辅助能力，包括支付方式选型、示例代码检索、业务知识查询、接入质量评估和问题排查。
 
-- [基础支付接入Skill](https://pay.weixin.qq.com/doc/v3/merchant/4019638116.md)
+- [微信支付接入Skill](https://pay.weixin.qq.com/doc/v3/merchant/4019638116.md)
...
@@ -346,9 +346,9 @@
 ...
 ##### APP调起用户确认收款
-- [Android](https://pay.weixin.qq.com/doc/v3/merchant/4012719576.md)
-- [iOS](https://pay.weixin.qq.com/doc/v3/merchant/4012719578.md)
-- [鸿蒙](https://pay.weixin.qq.com/doc/v3/merchant/4019670774.md)
...
- 更新时间变更: 2026-04-09 03:13:23 -> 2026-06-24 07:16:35
...
- 更新时间变更: 2026-05-09 08:56:42 -> 2026-06-24 09:41:30
...
|------|-------------|----|----------|----------|
| 1 | [微信支付接入Skill](pages/4019638116.md) | `4019638116` | 2026-06-24 07:16:35 | Skills |
